...
public class StarMenuScript : MonoBehaviour
{
  ...
  public void PushLeoButton()
  {
    ...
    CommandText.text = "しし座の力を借りて、相手に攻撃力×6.0のダメージ\nさらに3Tの間、敵の攻撃力を50%ダウンさせる";
  }
  ...
  public void PushAriesButton()
  {
    ...
    CommandText.text = "おひつじ座の力を借りて、3Tの間、自分の防御力を3倍にする\nその後、相手全体に自身の防御力×10のダメージ";
  }
  ...
  public void PushSagittariusButton()
  {
    ...
    CommandText.text = "いて座の力を借りて、相手に攻撃力Xの貫通ダメージ\nその後、自分のHPをX回復 Xはこのとき自分が受けていたダメージ";
  }
